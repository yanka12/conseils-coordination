<footer id="contact" class="relative overflow-hidden bg-gradient-to-r from-brand-600 via-brand-500 to-brand-400 text-white">
    ...
    <div class="relative mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-[1fr_1.5fr_1fr] lg:items-center lg:px-8">

        {{-- Colonne 1 : logo. Le PNG est bleu marine sur fond transparent ; ces deux filtres
             le rendent entièrement blanc, seule façon de le poser sur ce fond bleu. --}}
        ...
        <div class="overflow-hidden rounded-3xl shadow-xl">
            <iframe
                ...
                class="aspect-[3/4] w-full border-0"
                allowfullscreen
                loading="lazy"
